...
const styles = StyleSheet.create({
  ...
  trialBadgeText: { fontSize: 13, fontWeight: '700', color: '#F59E0B' },
  heroTitle: { 
    fontSize: 28, 
    fontWeight: 'bold', 
    color: '#FFF', 
  ...
  planPrice: { fontSize: 24, fontWeight: 'bold', color: '#FFF', textAlign: 'right' },
  ...
  featText: { fontSize: 13, color: 'rgba(255,255,255,0.9)' },
