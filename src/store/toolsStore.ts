...
const SAMPLE_TOOLS: Tool[] = [
  ...
  { $id: 'm2', name: 'Facebook Carousel Ads', slug: 'facebook-carousel', shortDescription: 'Carousel card copy', description: 'Write compelling copy for each carousel card.', icon: 'layers', category: 'facebook-ads', isPro: false, isNew: false, isTrending: true, usageCount: 9800, rating: 4.7, inputs: [{ name: 'products', label: 'Products/Services', type: 'textarea', required: true }], outputType: 'text', tags: ['carousel', 'facebook'] },
  { $id: 'm3', name: 'Facebook Lead Forms', slug: 'facebook-lead-forms', shortDescription: 'Lead generation forms', description: 'Design high-converting lead ad forms.', icon: 'user-plus', category: 'facebook-ads', isPro: true, isNew: false, isTrending: false, usageCount: 5600, rating: 4.6, inputs: [{ name: 'offer', label: 'Lead Magnet', type: 'text', required: true }], outputType: 'text', tags: ['leads', 'forms'] },
  { $id: 'm4', name: 'Facebook Video Script', slug: 'facebook-video-script', shortDescription: 'Video ad scripts', description: 'Create engaging video ad scripts for Facebook.', icon: 'video', category: 'facebook-ads', isPro: true, isNew: true, isTrending: true, usageCount: 7200, rating: 4.8, inputs: [{ name: 'duration', label: 'Duration', type: 'select', required: true, options: ['15 sec', '30 sec', '60 sec'] }], outputType: 'text', tags: ['video', 'scripts'] },
  { $id: 'm5', name: 'Facebook Retargeting', slug: 'facebook-retargeting', shortDescription: 'Retargeting ad copy', description: 'Re-engage website visitors with compelling copy.', icon: 'repeat', category: 'facebook-ads', isPro: true, isNew: false, isTrending: true, usageCount: 6800, rating: 4.7, inputs: [{ name: 'stage', label: 'Funnel Stage', type: 'select', required: true, options: ['Viewed Product', 'Added to Cart', 'Checkout Abandoned'] }], outputType: 'text', tags: ['retargeting', 'facebook'] },
  // Instagram Category (20 tools)
  { $id: 'm6', name: 'Instagram Caption', slug: 'instagram-captions', shortDescription: 'Engaging IG captions', description: 'Create viral Instagram captions with hashtags.', icon: 'instagram', category: 'instagram', isPro: false, isNew: false, isTrending: true, usageCount: 22000, rating: 4.9, inputs: [{ name: 'topic', label: 'Post Topic', type: 'text', required: true }, { name: 'mood', label: 'Mood', type: 'select', required: true, options: ['Inspiring', 'Funny', 'Educational', 'Promotional'] }], outputType: 'text', tags: ['instagram', 'captions'] },
  ...
  { $id: 'c3', name: 'Quote Image', slug: 'quote-image', shortDescription: 'Create beautiful quote images', description: 'Design shareable quote images for social media.', icon: 'feather', category: 'content-creation', isPro: false, isNew: false, isTrending: true, usageCount: 12800, rating: 4.7, inputs: [{ name: 'quote', label: 'Quote Text', type: 'textarea', required: true }], outputType: 'image', tags: ['quote', 'image', 'design'] },
  ...
  // ===== ADDITIONAL MOBILE TOOLS (from web app) =====

  // Copywriting & Content
  { $id: 'nw1', name: 'Content Rewriter', slug: 'content-rewriter', shortDescription: 'Rewrite content with AI', description: 'Rewrite and improve existing content while keeping the message.', icon: 'refresh-cw', category: 'copywriting', isPro: false, isNew: false, isTrending: true, usageCount: 18200, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Original Content', type: 'textarea', required: true, placeholder: 'Paste content to rewrite...' }], outputType: 'text', tags: ['rewrite', 'content', 'ai'] },
  { $id: 'nw2', name: 'Article Rewriter', slug: 'article-rewriter', shortDescription: 'Rewrite articles uniquely', description: 'Transform articles into fresh unique content.', icon: 'edit', category: 'copywriting', isPro: false, isNew: false, isTrending: true, usageCount: 16400, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Article Text', type: 'textarea', required: true, placeholder: 'Paste the article...' }], outputType: 'text', tags: ['article', 'rewrite'] },
  { $id: 'nw3', name: 'Article Summarizer', slug: 'article-summarizer', shortDescription: 'Summarize long articles', description: 'Get concise summaries of long articles and content.', icon: 'minimize-2', category: 'copywriting', isPro: false, isNew: false, isTrending: true, usageCount: 14800, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Article Text', type: 'textarea', required: true, placeholder: 'Paste the article to summarize...' }], outputType: 'text', tags: ['summarize', 'article'] },
  { $id: 'nw4', name: 'CTA Writer', slug: 'cta-writer', shortDescription: 'Write powerful CTAs', description: 'Generate compelling call-to-action text that converts.', icon: 'mouse-pointer', category: 'copywriting', isPro: false, isNew: false, isTrending: true, usageCount: 12600, rating: 4.8, inputs: [{ name: 'mainInput', label: 'What action do you want?', type: 'textarea', required: true, placeholder: 'Describe the desired action...' }], outputType: 'text', tags: ['cta', 'conversion', 'copy'] },
  { $id: 'nw5', name: 'Sales Page Copy', slug: 'sales-page-copy-writer', shortDescription: 'Write sales page copy', description: 'Create high-converting sales page copy with persuasive frameworks.', icon: 'file-text', category: 'copywriting', isPro: true, isNew: false, isTrending: true, usageCount: 11200, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Product/Service', type: 'textarea', required: true, placeholder: 'Describe what you are selling...' }], outputType: 'text', tags: ['sales', 'copy', 'landing'] },
  { $id: 'nw6', name: 'Marketing Copy Generator', slug: 'marketing-copy-generator', shortDescription: 'Generate marketing copy', description: 'AI-powered marketing copy for any channel or format.', icon: 'type', category: 'copywriting', isPro: false, isNew: false, isTrending: true, usageCount: 15600, rating: 4.8, inputs: [{ name: 'mainInput', label: 'What do you need copy for?', type: 'textarea', required: true, placeholder: 'Describe your marketing goal...' }, { name: 'format', label: 'Format', type: 'select', required: false, options: ['Ad Copy', 'Email', 'Landing Page', 'Social Post', 'Banner'] }], outputType: 'text', tags: ['marketing', 'copy', 'generator'] },
  { $id: 'nw7', name: 'Brand Voice Generator', slug: 'brand-voice-generator', shortDescription: 'Define your brand voice', description: 'Create a consistent brand voice guide for all your content.', icon: 'mic', category: 'copywriting', isPro: true, isNew: true, isTrending: false, usageCount: 6800, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Brand Description', type: 'textarea', required: true, placeholder: 'Describe your brand personality...' }], outputType: 'text', tags: ['brand', 'voice', 'identity'] },
  { $id: 'nw8', name: 'Paragraph Rewriter', slug: 'paragraph-rewriter', shortDescription: 'Rewrite paragraphs', description: 'Rewrite paragraphs to improve clarity and engagement.', icon: 'edit-3', category: 'copywriting', isPro: false, isNew: false, isTrending: false, usageCount: 10200, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Paragraph', type: 'textarea', required: true, placeholder: 'Paste the paragraph...' }], outputType: 'text', tags: ['paragraph', 'rewrite'] },

  // SEO & Research
  { $id: 'nw9', name: 'SEO Audit Tool', slug: 'seo-audit-tool', shortDescription: 'Audit your website SEO', description: 'Get AI-powered SEO audit with actionable recommendations.', icon: 'search', category: 'google-seo', isPro: true, isNew: false, isTrending: true, usageCount: 13400, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Website URL or Details', type: 'textarea', required: true, placeholder: 'Enter website URL or describe your site...' }], outputType: 'text', tags: ['seo', 'audit', 'website'] },
  { $id: 'nw10', name: 'On-Page SEO Checker', slug: 'on-page-seo-checker', shortDescription: 'Check on-page SEO', description: 'Analyze and optimize on-page SEO elements.', icon: 'check-square', category: 'google-seo', isPro: false, isNew: false, isTrending: true, usageCount: 11800, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Page Content', type: 'textarea', required: true, placeholder: 'Paste your page content...' }, { name: 'keyword', label: 'Target Keyword', type: 'text', required: true }], outputType: 'text', tags: ['seo', 'on-page', 'checker'] },
  { $id: 'nw11', name: 'Content Gap Finder', slug: 'content-gap-finder', shortDescription: 'Find content gaps', description: 'Discover content opportunities your competitors are missing.', icon: 'crosshair', category: 'google-seo', isPro: true, isNew: true, isTrending: true, usageCount: 8400, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Your Niche/Topic', type: 'textarea', required: true, placeholder: 'Describe your niche or topic area...' }], outputType: 'text', tags: ['content', 'gap', 'seo'] },
  { $id: 'nw12', name: 'Competitor Analysis', slug: 'competitor-analysis-tool', shortDescription: 'Analyze competitors', description: 'AI-powered competitor analysis for marketing strategy.', icon: 'users', category: 'google-analytics', isPro: true, isNew: false, isTrending: true, usageCount: 9600, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Your Business & Competitors', type: 'textarea', required: true, placeholder: 'Describe your business and key competitors...' }], outputType: 'text', tags: ['competitor', 'analysis', 'strategy'] },
  { $id: 'nw13', name: 'SEO Title Generator', slug: 'seo-title-generator', shortDescription: 'Generate SEO titles', description: 'Create SEO-optimized page titles that rank and convert.', icon: 'hash', category: 'google-seo', isPro: false, isNew: false, isTrending: true, usageCount: 14200, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Page Topic', type: 'text', required: true, placeholder: 'Enter page topic...' }, { name: 'keyword', label: 'Target Keyword', type: 'text', required: true }], outputType: 'text', tags: ['seo', 'title', 'generator'] },
  { $id: 'nw14', name: 'Website Grader', slug: 'website-grader', shortDescription: 'Grade your website', description: 'Get an AI-powered grade and improvement tips for your website.', icon: 'globe', category: 'google-analytics', isPro: false, isNew: false, isTrending: true, usageCount: 12800, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Website URL or Description', type: 'textarea', required: true, placeholder: 'Enter website URL or describe it...' }], outputType: 'text', tags: ['website', 'grader', 'audit'] },

  // Lead Gen & Business
  { $id: 'nw15', name: 'Lead Magnet Creator', slug: 'lead-magnet-creator', shortDescription: 'Create lead magnets', description: 'Generate ideas and content for high-converting lead magnets.', icon: 'gift', category: 'email-marketing', isPro: true, isNew: false, isTrending: true, usageCount: 8900, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Your Business/Niche', type: 'textarea', required: true, placeholder: 'Describe your business and target audience...' }], outputType: 'text', tags: ['lead', 'magnet', 'marketing'] },
  { $id: 'nw16', name: 'ROI Calculator', slug: 'roi-calculator', shortDescription: 'Calculate marketing ROI', description: 'AI-powered ROI calculator for marketing campaigns.', icon: 'percent', category: 'google-analytics', isPro: false, isNew: false, isTrending: true, usageCount: 11400, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Campaign Details', type: 'textarea', required: true, placeholder: 'Describe your campaign spend and results...' }], outputType: 'text', tags: ['roi', 'calculator', 'analytics'] },
  { $id: 'nw17', name: 'Testimonial Generator', slug: 'testimonial-generator', shortDescription: 'Generate testimonial templates', description: 'Create professional testimonial request templates and examples.', icon: 'star', category: 'copywriting', isPro: false, isNew: false, isTrending: false, usageCount: 7200, rating: 4.5, inputs: [{ name: 'mainInput', label: 'Product/Service', type: 'textarea', required: true, placeholder: 'What is the testimonial for?' }], outputType: 'text', tags: ['testimonial', 'social-proof'] },
  { $id: 'nw18', name: 'Case Study Writer', slug: 'case-study-writer', shortDescription: 'Write case studies', description: 'Generate professional case studies from your success stories.', icon: 'file-text', category: 'copywriting', isPro: true, isNew: false, isTrending: false, usageCount: 5600, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Success Story Details', type: 'textarea', required: true, placeholder: 'Describe the client success story...' }], outputType: 'text', tags: ['case-study', 'b2b', 'content'] },
  { $id: 'nw19', name: 'FAQ Generator', slug: 'faq-generator', shortDescription: 'Generate FAQs', description: 'Create comprehensive FAQs for your product or service.', icon: 'help-circle', category: 'content-creation', isPro: false, isNew: false, isTrending: true, usageCount: 13200, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Product/Service', type: 'textarea', required: true, placeholder: 'Describe your product or service...' }], outputType: 'text', tags: ['faq', 'content', 'support'] },
  { $id: 'nw20', name: 'Press Release Generator', slug: 'press-release-generator', shortDescription: 'Write press releases', description: 'Generate professional press releases for any announcement.', icon: 'file-text', category: 'content-creation', isPro: true, isNew: false, isTrending: false, usageCount: 6400, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Announcement Details', type: 'textarea', required: true, placeholder: 'What is the announcement about?' }], outputType: 'text', tags: ['press', 'release', 'pr'] },

  // Instagram Extended
  { $id: 'nw21', name: 'Instagram Bio Optimizer', slug: 'instagram-bio-optimizer', shortDescription: 'Optimize your IG bio', description: 'Create an optimized Instagram bio that converts visitors.', icon: 'instagram', category: 'instagram', isPro: false, isNew: true, isTrending: true, usageCount: 14200, rating: 4.8, inputs: [{ name: 'mainInput', label: 'About You/Brand', type: 'textarea', required: true, placeholder: 'Describe your brand or personal profile...' }], outputType: 'text', tags: ['instagram', 'bio', 'optimize'] },
  { $id: 'nw22', name: 'Instagram Hashtag Strategy', slug: 'instagram-hashtag-strategy', shortDescription: 'Hashtag strategy for IG', description: 'Get a complete hashtag strategy for Instagram growth.', icon: 'hash', category: 'instagram', isPro: false, isNew: false, isTrending: true, usageCount: 16800, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Your Niche', type: 'text', required: true, placeholder: 'Enter your niche...' }], outputType: 'text', tags: ['instagram', 'hashtag', 'strategy'] },
  { $id: 'nw23', name: 'Instagram Carousel Designer', slug: 'instagram-carousel-designer', shortDescription: 'Design IG carousels', description: 'Generate content and layout ideas for Instagram carousels.', icon: 'layout', category: 'instagram', isPro: true, isNew: true, isTrending: true, usageCount: 11600, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Carousel Topic', type: 'textarea', required: true, placeholder: 'What is the carousel about?' }], outputType: 'text', tags: ['instagram', 'carousel', 'design'] },
  { $id: 'nw24', name: 'Instagram Ad Creative', slug: 'instagram-ad-creative-generator', shortDescription: 'IG ad creatives', description: 'Generate Instagram ad creative concepts and copy.', icon: 'instagram', category: 'instagram', isPro: true, isNew: false, isTrending: true, usageCount: 9800, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Ad Details', type: 'textarea', required: true, placeholder: 'What are you advertising?' }], outputType: 'text', tags: ['instagram', 'ads', 'creative'] },

  // Google Ads Extended
  { $id: 'nw25', name: 'Google Ads Quality Score', slug: 'google-ads-quality-score', shortDescription: 'Improve Quality Score', description: 'Get AI recommendations to improve your Google Ads Quality Score.', icon: 'award', category: 'google-ads', isPro: true, isNew: false, isTrending: true, usageCount: 8600, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Ad & Landing Page Details', type: 'textarea', required: true, placeholder: 'Describe your ad copy and landing page...' }], outputType: 'text', tags: ['google', 'quality-score', 'ads'] },
  { $id: 'nw26', name: 'Google Ads Performance Grader', slug: 'google-ads-performance-grader', shortDescription: 'Grade your Google Ads', description: 'Comprehensive AI grading of your Google Ads performance.', icon: 'trending-up', category: 'google-ads', isPro: false, isNew: false, isTrending: true, usageCount: 10200, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Account Overview', type: 'textarea', required: true, placeholder: 'Describe your Google Ads metrics...' }], outputType: 'text', tags: ['google', 'performance', 'grader'] },
  { $id: 'nw27', name: 'Negative Keywords Tool', slug: 'negative-keywords-tool', shortDescription: 'Find negative keywords', description: 'Discover negative keywords to reduce wasted ad spend.', icon: 'minus-circle', category: 'google-ads', isPro: false, isNew: false, isTrending: true, usageCount: 9400, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Campaign/Keywords', type: 'textarea', required: true, placeholder: 'Enter your campaign keywords...' }], outputType: 'text', tags: ['negative', 'keywords', 'google'] },

  // Meta/Facebook Extended
  { $id: 'nw28', name: 'Facebook Ads Performance Grader', slug: 'facebook-ads-performance-grader', shortDescription: 'Grade FB Ads performance', description: 'AI grading of your Facebook Ads with improvement tips.', icon: 'facebook', category: 'facebook-ads', isPro: false, isNew: false, isTrending: true, usageCount: 9200, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Campaign Metrics', type: 'textarea', required: true, placeholder: 'Describe your FB Ads performance...' }], outputType: 'text', tags: ['facebook', 'performance', 'grader'] },
  { $id: 'nw29', name: 'Meta Audience Builder', slug: 'meta-audience-builder', shortDescription: 'Build Meta audiences', description: 'Create targeted audience segments for Meta ads.', icon: 'users', category: 'facebook-ads', isPro: true, isNew: true, isTrending: true, usageCount: 7800, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Target Customer', type: 'textarea', required: true, placeholder: 'Describe your ideal customer...' }], outputType: 'text', tags: ['meta', 'audience', 'targeting'] },

  // Shopify Extended
  { $id: 'nw30', name: 'Shopify Store Audit', slug: 'shopify-store-audit', shortDescription: 'Audit your Shopify store', description: 'Get AI-powered audit and optimization tips for your Shopify store.', icon: 'clipboard', category: 'ecommerce-seo', isPro: true, isNew: false, isTrending: true, usageCount: 8400, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Store Details', type: 'textarea', required: true, placeholder: 'Describe your Shopify store...' }], outputType: 'text', tags: ['shopify', 'audit', 'store'] },
  { $id: 'nw31', name: 'Product Description Writer', slug: 'product-description-writer', shortDescription: 'Write product descriptions', description: 'Generate compelling product descriptions that drive sales.', icon: 'shopping-bag', category: 'shopify-products', isPro: false, isNew: false, isTrending: true, usageCount: 15200, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Product Details', type: 'textarea', required: true, placeholder: 'Describe the product...' }], outputType: 'text', tags: ['product', 'description', 'ecommerce'] },

  // Marketing Strategy
  { $id: 'nw32', name: 'Marketing Calendar', slug: 'marketing-calendar', shortDescription: 'Plan marketing calendar', description: 'Generate a complete marketing calendar with campaigns and events.', icon: 'calendar', category: 'ai-agents', isPro: true, isNew: false, isTrending: true, usageCount: 10800, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Business & Goals', type: 'textarea', required: true, placeholder: 'Describe your business and marketing goals...' }], outputType: 'text', tags: ['marketing', 'calendar', 'planning'] },
  { $id: 'nw33', name: 'Marketing Budget Planner', slug: 'marketing-budget-planner', shortDescription: 'Plan marketing budget', description: 'AI-powered marketing budget allocation and planning.', icon: 'dollar-sign', category: 'ai-agents', isPro: true, isNew: false, isTrending: false, usageCount: 7600, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Budget & Goals', type: 'textarea', required: true, placeholder: 'Describe your budget and marketing goals...' }], outputType: 'text', tags: ['budget', 'planning', 'marketing'] },
  { $id: 'nw34', name: 'Marketing Proposal', slug: 'marketing-proposal-generator', shortDescription: 'Write marketing proposals', description: 'Generate professional marketing proposals for clients.', icon: 'file-text', category: 'ai-agents', isPro: true, isNew: false, isTrending: false, usageCount: 5800, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Client & Project Details', type: 'textarea', required: true, placeholder: 'Describe the client and project...' }], outputType: 'text', tags: ['proposal', 'marketing', 'client'] },

  // Email Extended
  { $id: 'nw35', name: 'Backlink Outreach Email', slug: 'backlink-outreach-email-generator', shortDescription: 'Write outreach emails', description: 'Generate personalized backlink outreach emails for SEO.', icon: 'mail', category: 'email-marketing', isPro: false, isNew: false, isTrending: true, usageCount: 9800, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Your Site & Target', type: 'textarea', required: true, placeholder: 'Describe your site and the target site...' }], outputType: 'text', tags: ['backlink', 'outreach', 'email'] },

  // Podcast & Webinar
  { $id: 'nw36', name: 'Webinar Script Writer', slug: 'webinar-script-writer', shortDescription: 'Write webinar scripts', description: 'Generate structured webinar scripts that engage your audience.', icon: 'monitor', category: 'content-creation', isPro: true, isNew: false, isTrending: false, usageCount: 4800, rating: 4.5, inputs: [{ name: 'mainInput', label: 'Webinar Topic', type: 'textarea', required: true, placeholder: 'What is the webinar about?' }], outputType: 'text', tags: ['webinar', 'script', 'presentation'] },
  { $id: 'nw37', name: 'Podcast Script Writer', slug: 'podcast-script-writer', shortDescription: 'Write podcast scripts', description: 'Generate engaging podcast episode scripts and show notes.', icon: 'mic', category: 'content-creation', isPro: true, isNew: false, isTrending: false, usageCount: 5200, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Episode Topic', type: 'textarea', required: true, placeholder: 'What is the podcast episode about?' }], outputType: 'text', tags: ['podcast', 'script', 'audio'] },

  // Schema & Technical
  { $id: 'nw38', name: 'FAQ Schema Writer', slug: 'faq-schema-writer', shortDescription: 'Generate FAQ schema', description: 'Create FAQ structured data markup for rich snippets.', icon: 'code', category: 'google-seo', isPro: false, isNew: false, isTrending: false, usageCount: 6200, rating: 4.5, inputs: [{ name: 'mainInput', label: 'FAQ Questions & Answers', type: 'textarea', required: true, placeholder: 'Enter your FAQs...' }], outputType: 'code', tags: ['faq', 'schema', 'seo'] },
  { $id: 'nw39', name: 'Landing Page Audit', slug: 'landing-page-audit', shortDescription: 'Audit landing pages', description: 'Get AI analysis and optimization tips for your landing page.', icon: 'layout', category: 'google-analytics', isPro: true, isNew: false, isTrending: true, usageCount: 8200, rating: 4.7, inputs: [{ name: 'mainInput', label: 'Landing Page Details', type: 'textarea', required: true, placeholder: 'Describe or paste your landing page content...' }], outputType: 'text', tags: ['landing', 'page', 'audit'] },

  // ===== TOOLS FROM PLAY STORE (visible in live screenshots) =====
  { $id: 'ps1', name: 'Newsletter Writer', slug: 'newsletter-writer', shortDescription: 'Write email newsletters', description: 'Generate engaging newsletter content for your subscribers.', icon: 'mail', category: 'email-marketing', isPro: false, isNew: false, isTrending: false, usageCount: 8400, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Newsletter Topic', type: 'textarea', required: true, placeholder: 'What is the newsletter about?' }], outputType: 'text', tags: ['newsletter', 'email', 'content'] },
  { $id: 'ps2', name: 'Comparison Chart Creator', slug: 'comparison-chart-creator', shortDescription: 'Create comparison charts', description: 'Generate professional comparison charts for products and services.', icon: 'columns', category: 'content-creation', isPro: false, isNew: false, isTrending: false, usageCount: 7200, rating: 4.5, inputs: [{ name: 'mainInput', label: 'Items to Compare', type: 'textarea', required: true, placeholder: 'List the items and features to compare...' }], outputType: 'text', tags: ['comparison', 'chart', 'content'] },
  { $id: 'ps3', name: 'Market Research Summary', slug: 'market-research-summary', shortDescription: 'Summarize market research', description: 'AI-powered market research analysis and summary generation.', icon: 'pie-chart', category: 'ai-agents', isPro: true, isNew: false, isTrending: false, usageCount: 6800, rating: 4.6, inputs: [{ name: 'mainInput', label: 'Research Data', type: 'textarea', required: true, placeholder: 'Describe the market or paste research data...' }], outputType: 'text', tags: ['market', 'research', 'analysis'] },
  { $id: 'ps4', name: 'Affiliate Marketing Copy', slug: 'affiliate-marketing-copy', shortDescription: 'Write affiliate copy', description: 'Create persuasive affiliate marketing content and reviews.', icon: 'link', category: 'copywriting', isPro: false, isNew: false, isTrending: false, usageCount: 7600, rating: 4.5, inputs: [{ name: 'mainInput', label: 'Product Details', type: 'textarea', required: true, placeholder: 'Describe the affiliate product...' }], outputType: 'text', tags: ['affiliate', 'marketing', 'copy'] },
  { $id: 'ps5', name: 'AI Campaign Manager', slug: 'ai-campaign-manager', shortDescription: 'AI-powered campaign management', description: 'Let AI manage and optimize your marketing campaigns automatically.', icon: 'cpu', category: 'ai-agents', isPro: true, isNew: true, isTrending: true, usageCount: 4200, rating: 4.8, inputs: [{ name: 'mainInput', label: 'Campaign Details', type: 'textarea', required: true, placeholder: 'Describe your campaign goals and setup...' }], outputType: 'text', tags: ['ai', 'campaign', 'manager'] },
  { $id: 'ps6', name: 'Copy Generator', slug: 'copy-generator', shortDescription: 'Generate any marketing copy', description: 'All-purpose marketing copy generator for any channel.', icon: 'type', category: 'copywriting', isPro: false, isNew: false, isTrending: false, usageCount: 13200, rating: 4.7, inputs: [{ name: 'mainInput', label: 'What copy do you need?', type: 'textarea', required: true, placeholder: 'Describe the copy you need...' }], outputType: 'text', tags: ['copy', 'generator', 'marketing'] },
