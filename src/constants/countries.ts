...
export const COUNTRIES: Country[] = [
  ...
  { iso2: 'AU', name: "Australia", dialCode: '+61', flag: '🇦🇺', minLen: 9, maxLen: 9 },
  { iso2: 'AT', name: "Austria", dialCode: '+43', flag: '🇦🇹', minLen: 10, maxLen: 13 },
  { iso2: 'AZ', name: "Azerbaijan", dialCode: '+994', flag: '🇦🇿' },
  { iso2: 'BS', name: "Bahamas", dialCode: '+1', flag: '🇧🇸' },
  { iso2: 'BH', name: "Bahrain", dialCode: '+973', flag: '🇧🇭' },
  { iso2: 'BD', name: "Bangladesh", dialCode: '+880', flag: '🇧🇩', minLen: 10, maxLen: 10 },
  { iso2: 'BB', name: "Barbados", dialCode: '+1', flag: '🇧🇧' },
  { iso2: 'BY', name: "Belarus", dialCode: '+375', flag: '🇧🇾' },
  { iso2: 'BE', name: "Belgium", dialCode: '+32', flag: '🇧🇪', minLen: 8, maxLen: 9 },
  ...
  { iso2: 'BR', name: "Brazil", dialCode: '+55', flag: '🇧🇷', minLen: 10, maxLen: 11 },
  ...
  { iso2: 'CA', name: "Canada", dialCode: '+1', flag: '🇨🇦', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'CN', name: "China", dialCode: '+86', flag: '🇨🇳', minLen: 11, maxLen: 11 },
  ...
  { iso2: 'DK', name: "Denmark", dialCode: '+45', flag: '🇩🇰', minLen: 8, maxLen: 8 },
  ...
  { iso2: 'EG', name: "Egypt", dialCode: '+20', flag: '🇪🇬', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'FR', name: "France", dialCode: '+33', flag: '🇫🇷', minLen: 9, maxLen: 9 },
  ...
  { iso2: 'DE', name: "Germany", dialCode: '+49', flag: '🇩🇪', minLen: 10, maxLen: 11 },
  { iso2: 'GH', name: "Ghana", dialCode: '+233', flag: '🇬🇭' },
  { iso2: 'GI', name: "Gibraltar", dialCode: '+350', flag: '🇬🇮' },
  { iso2: 'GR', name: "Greece", dialCode: '+30', flag: '🇬🇷', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'IN', name: "India", dialCode: '+91', flag: '🇮🇳', minLen: 10, maxLen: 10 },
  { iso2: 'ID', name: "Indonesia", dialCode: '+62', flag: '🇮🇩', minLen: 9, maxLen: 12 },
  ...
  { iso2: 'KE', name: "Kenya", dialCode: '+254', flag: '🇰🇪', minLen: 9, maxLen: 9 },
  ...
  { iso2: 'MY', name: "Malaysia", dialCode: '+60', flag: '🇲🇾', minLen: 9, maxLen: 10 },
  ...
  { iso2: 'MX', name: "Mexico", dialCode: '+52', flag: '🇲🇽', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'NL', name: "Netherlands", dialCode: '+31', flag: '🇳🇱', minLen: 9, maxLen: 9 },
  { iso2: 'NC', name: "New Caledonia", dialCode: '+687', flag: '🇳🇨' },
  { iso2: 'NZ', name: "New Zealand", dialCode: '+64', flag: '🇳🇿', minLen: 8, maxLen: 10 },
  { iso2: 'NI', name: "Nicaragua", dialCode: '+505', flag: '🇳🇮' },
  { iso2: 'NE', name: "Niger", dialCode: '+227', flag: '🇳🇪' },
  { iso2: 'NG', name: "Nigeria", dialCode: '+234', flag: '🇳🇬', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'NO', name: "Norway", dialCode: '+47', flag: '🇳🇴', minLen: 8, maxLen: 8 },
  { iso2: 'OM', name: "Oman", dialCode: '+968', flag: '🇴🇲' },
  { iso2: 'PK', name: "Pakistan", dialCode: '+92', flag: '🇵🇰', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'PH', name: "Philippines", dialCode: '+63', flag: '🇵🇭', minLen: 10, maxLen: 10 },
  { iso2: 'PN', name: "Pitcairn Islands", dialCode: '+64', flag: '🇵🇳' },
  { iso2: 'PL', name: "Poland", dialCode: '+48', flag: '🇵🇱', minLen: 9, maxLen: 9 },
  { iso2: 'PT', name: "Portugal", dialCode: '+351', flag: '🇵🇹', minLen: 9, maxLen: 9 },
  ...
  { iso2: 'RU', name: "Russia", dialCode: '+7', flag: '🇷🇺', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'SA', name: "Saudi Arabia", dialCode: '+966', flag: '🇸🇦', minLen: 9, maxLen: 9 },
  ...
  { iso2: 'SG', name: "Singapore", dialCode: '+65', flag: '🇸🇬', minLen: 8, maxLen: 8 },
  ...
  { iso2: 'ZA', name: "South Africa", dialCode: '+27', flag: '🇿🇦', minLen: 9, maxLen: 9 },
  { iso2: 'KR', name: "South Korea", dialCode: '+82', flag: '🇰🇷', minLen: 9, maxLen: 10 },
  { iso2: 'SS', name: "South Sudan", dialCode: '+211', flag: '🇸🇸' },
  { iso2: 'ES', name: "Spain", dialCode: '+34', flag: '🇪🇸', minLen: 9, maxLen: 9 },
  ...
  { iso2: 'SE', name: "Sweden", dialCode: '+46', flag: '🇸🇪', minLen: 7, maxLen: 13 },
  { iso2: 'CH', name: "Switzerland", dialCode: '+41', flag: '🇨🇭', minLen: 9, maxLen: 9 },
  ...
  { iso2: 'TH', name: "Thailand", dialCode: '+66', flag: '🇹🇭', minLen: 9, maxLen: 9 },
  ...
  { iso2: 'TR', name: "Türkiye", dialCode: '+90', flag: '🇹🇷', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'AE', name: "United Arab Emirates", dialCode: '+971', flag: '🇦🇪', minLen: 9, maxLen: 9 },
  { iso2: 'GB', name: "United Kingdom", dialCode: '+44', flag: '🇬🇧', minLen: 9, maxLen: 10 },
  { iso2: 'US', name: "United States", dialCode: '+1', flag: '🇺🇸', minLen: 10, maxLen: 10 },
  ...
  { iso2: 'VN', name: "Vietnam", dialCode: '+84', flag: '🇻🇳', minLen: 9, maxLen: 10 },
