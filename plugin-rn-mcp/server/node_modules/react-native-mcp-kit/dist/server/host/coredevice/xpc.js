...
exports.parseXpcWrapper = exports.buildXpcWrapper = exports.XpcFlags = void 0;
    ...
    switch (type) {
        ...
        case TYPE_ARRAY: {
            ...
            for (let i = 0; i < count; i++)
                items.push(decodeObject(reader));
            return items;
        }
...
const encodeObject = (writer, value) => {
    if (value === null) {
    ...
    if (typeof value === 'object') {
        ...
        for (const [key, val] of entries) {
            ...
            if (padding)
                body.bytes(Buffer.alloc(padding));
...
const encodeXpcObject = (value) => {
    const writer = new Writer();
    encodeObject(writer, value);
    return writer.build();
};
const decodeXpcObject = (buf) => {
...
const buildXpcWrapper = (flags, messageId, payload) => {
    const writer = new Writer();
...
exports.buildXpcWrapper = buildXpcWrapper;
const parseXpcWrapper = (buf, offset = 0) => {
...
exports.parseXpcWrapper = parseXpcWrapper;
