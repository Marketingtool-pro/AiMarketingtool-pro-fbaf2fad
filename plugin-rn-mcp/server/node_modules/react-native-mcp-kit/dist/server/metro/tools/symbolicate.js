...
const parseStackString = (stack) => {
    ...
    while ((match = hermesRegex.exec(body)) !== null) {
        ...
        frames.push({
            ...
            file: match[2],
            lineNumber: Number.parseInt(match[3], 10),
            methodName: methodName && methodName.length > 0 && methodName !== 'anonymous' ? methodName : undefined,
        });
    }
    return frames;
};
  ...
  Opt-out via includeFrameworkFrames / maxFrames / fullPaths.`,
        ...
        inputSchema: {
            ...
            includeFrameworkFrames: {
                default: false,
                description: 'Keep node_modules / React Native internal frames (marked collapse: true by Metro). Framework noise is dropped by default to save tokens.',
                type: 'boolean',
            },
            maxFrames: {
