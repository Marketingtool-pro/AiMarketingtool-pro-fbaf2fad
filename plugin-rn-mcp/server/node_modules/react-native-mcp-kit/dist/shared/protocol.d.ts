...
export declare const PACKAGE_NAME = "react-native-mcp-kit";
...
export declare const DEFAULT_PORT = 8347;
...
export declare const WS_CLOSE_PROTOCOL_MISMATCH = 4010;
...
export type ClientMessage = RegistrationMessage | ToolRegisterMessage | ToolResponse | ToolUnregisterMessage;
