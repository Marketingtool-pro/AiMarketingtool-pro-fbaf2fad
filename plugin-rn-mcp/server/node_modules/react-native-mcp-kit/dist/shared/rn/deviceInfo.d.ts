 ...
 */
export declare const loadDeviceInfo: () => AnyDI | null;
/** Test-only: drop the memoised module so the next call re-requires. */
export declare const __resetDeviceInfoCache: () => void;
/**
 ...
 */
export declare const callDI: <T>(fn: unknown, fallback?: T | null) => T | null;
/** Async variant of `callDI` for DI methods that return Promises. */
export declare const callDIAsync: <T>(fn: unknown, fallback?: T | null) => Promise<T | null>;
/**
 ...
 */
export declare const DEVICE_INFO_UNAVAILABLE: {
    readonly reason: "react-native-device-info is not installed. Add it as a dependency to expose battery / memory / disk / extended identity fields.";
