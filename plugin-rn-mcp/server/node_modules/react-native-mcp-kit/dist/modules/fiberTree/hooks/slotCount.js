    ...
    if (Array.isArray(annotated)) {
        ...
        for (const entry of annotated) {
            if (entry && entry.kind === 'Custom' && typeof entry.fn === 'function') {
                total += (0, exports.countHookSlots)(entry.fn, depth + 1, localSeen);
            }
            else {
                total += 1;
            }
...
exports.countHookSlots = countHookSlots;
//# sourceMappingURL=slotCount.js.map