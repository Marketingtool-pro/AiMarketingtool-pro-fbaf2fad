 ...
 * invalid.
 */
const runWaitForLoop = async (waitForRaw, runOnce) => {
    ...
    const timeout = Math.min(constants_1.WAIT_TIMEOUT_MAX, Math.max(0, waitForRaw.timeout ?? constants_1.WAIT_TIMEOUT_DEFAULT));
    const interval = Math.max(constants_1.WAIT_INTERVAL_MIN, waitForRaw.interval ?? constants_1.WAIT_INTERVAL_DEFAULT);
...
exports.runWaitForLoop = runWaitForLoop;
