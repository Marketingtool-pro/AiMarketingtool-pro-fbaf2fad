...
exports.getAvailableMethods = exports.measureFiber = exports.getNativeInstance = void 0;
const core_1 = require("../../../shared/rn/core");
const traverse_1 = require("./traverse");
// Get the native instance (stateNode) or ref from a fiber
const getNativeInstance = (fiber) => {
    // For host components, stateNode has the native instance
    const hostFiber = (0, traverse_1.findHostFiber)(fiber);
    ...
    if (fiber.ref) {
        if (typeof fiber.ref === 'function')
            return null;
        if (fiber.ref.current)
            return fiber.ref.current;
    }
    return null;
};
exports.getNativeInstance = getNativeInstance;
...
const measureFiber = async (fiber) => {
    const hostFiber = (0, traverse_1.findHostFiber)(fiber);
    if (!hostFiber?.stateNode)
        return null;
...
exports.measureFiber = measureFiber;
const getAvailableMethods = (instance) => {
