        ...
        visitor: {
            ...
            CallExpression(path, state) {
                ...
                if (t.isMemberExpression(path.node.callee) &&
                    ...
                    ['registerModule', 'registerModules', 'registerTool', 'dispose', 'enableDebug'].includes(path.node.callee.property.name)) {
            ...
            JSXElement(path) {
                ...
                path.replaceWith(t.jsxFragment(t.jsxOpeningFragment(), t.jsxClosingFragment(), realChildren));
            },
        },
    };
}
//# sourceMappingURL=stripPlugin.js.map