...
BAZEL_COMMAND_LIST="aquery build canonicalize-flags clean config coverage cquery dump fetch help info license mobile-install mod print_action query run shutdown test vendor version"
BAZEL_INFO_KEYS="
workspace
install_base
install_md5
...
--noallow_experimental_loads
--allow_one_action_on_resource_unavailable
--noallow_one_action_on_resource_unavailable
...
--noexperimental_async_execution
...
--experimental_cancel_concurrent_tests={never,on_failed,on_passed}
...
--noexperimental_enable_thread_dump
--experimental_enforce_transitive_visibility
--noexperimental_enforce_transitive_visibility
...
--experimental_frontier_violation_check={strict,warn,disabled_for_testing}
--experimental_frontier_violation_verbose
--noexperimental_frontier_violation_verbose
...
--noexperimental_remote_cache_chunking
...
--noexperimental_starlark_type_checking
...
--noincompatible_builtin_objc_strip_action
...
--noincompatible_compact_repo_mapping_manifest
...
--noincompatible_filegroup_runfiles_for_data
...
--noincompatible_remote_local_fallback_for_remote_cache
...
--noincompatible_resolve_select_keys_eagerly
...
--noproto:include_starlark_rule_env
...
--nosandbox_enable_loopback_device
...
--test_size_filters=
--test_strategy=
--test_summary={short,short_uncached,terse,detailed,detailed_uncached,none,testcase}
--test_tag_filters=
--test_timeout=
...
--nouse_platforms_in_apple_crosstool_transition
...
--show_timestamps
--noshow_timestamps
--skyframe={off,summary,count,value,deps,rdeps,function_graph,active_directories,active_directories_frontier_deps}
--skyframe_high_water_mark_full_gc_drops_per_invocation=
--skyframe_high_water_mark_minor_gc_drops_per_invocation=
--skyframe_high_water_mark_threshold=
--skykey_filter=
...
--incremental_dexing
--noincremental_dexing
--info_output_type={stdout,response_proto}
--inject_repository=
--instrument_test_targets
--noinstrument_test_targets
--instrumentation_filter=
...
--module_mirrors=
--nested_set_depth_limit=
--output={text,json,graph,streamed_proto,streamed_jsonproto}
--override_module=
--override_repository=
--package_path=
--platform_suffix=
